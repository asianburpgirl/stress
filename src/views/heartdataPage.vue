        ...
        <ion-card-content>
          <ion-list>
            <ion-item v-for="item in userData" :key="item.id">
              ...
              <ion-note
                :style="{ color: 'red' }"
                v-if="Number(item.amount) < 65"
                slot="end"
                >{{ item.amount }}</ion-note
              >
              <ion-note :style="{ color: 'green' }" v-else slot="end">{{
                item.amount
              }}</ion-note>
            </ion-item>
          </ion-list>
        ...
        datasets: [
          {
            label: "HRV",
            data: [
              59.24640691, 46.89195955, 64.40598994, 76.24500979, 66.0516333,
              70.89614346277754, 67.28650447311502,
            ],
            fill: false,
